...
function dragItem(i: number, item: any, e: any) {
  // console.log('dragItem', i, item, e);
  e.preventDefault()
}

function dragstartItem(i: number, item: any, e: any) {
  dragIndex.value = i
}

function dragoverItem(i: number, item: any, e: any) {
  // console.log('leave', e)
  e.preventDefault()
}

function dragenterItem(i: number, item: any, e: any) {
  e.preventDefault()
  ...
  <div class="quick-links-container-box">
    <TransitionGroup class="quick-links-container" name="sort" tag="div">
      <div
        ...
        @dragend="dragendItem"
      >
        <svg-icon :name="item.icon" size="2em" :color="item.iconColor" />
