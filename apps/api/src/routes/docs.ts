...
const openApiDocument = {
  openapi: '3.0.3',
  info: {
    title: 'Wex Design Studio API',
    version: '0.1.0',
    description: 'Wex Design Studio 后端 API 文档',
  },
...
<head>
  ...
  <title>Wex Design Studio API Docs</title>
  <style>
...
<body>
  <header><h1>Wex Design Studio API</h1><p>OpenAPI 3.0.3 · 本地开发文档</p></header>
