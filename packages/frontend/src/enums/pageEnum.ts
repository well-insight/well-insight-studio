...
export enum PageEnum {
  ...
  // 应用集
  BASE_HOME_APPS = '/project/apps',
  BASE_HOME_APPS_NAME = 'Project-Apps',

  // 应用编辑
  BASE_HOME_APP_EDIT = '/project/apps/edit/:id(.*)*',
  BASE_HOME_APP_EDIT_NAME = 'Project-Apps-Edit',

  // 数据集
  BASE_HOME_DATA = '/project/data',
  BASE_HOME_DATA_NAME = 'Project-Data',

  // 数据连接
  BASE_HOME_APIS = '/project/apis',
  BASE_HOME_APIS_NAME = 'Project-Apis',

  // 自动化
  BASE_HOME_AUTOMATIONS = '/project/automations',
  BASE_HOME_AUTOMATIONS_NAME = 'Project-Automations',
