...
export default {
  ...
  label: '轮播图',
  preview: () => <SvgIcon name='carouselHorizontal' size={40} color='var(--el-color-primary)'></SvgIcon>,
  ...
  props: {
    ...
    slides: createEditorCrossSortableProp({
      ...
      defaultValue: [
        { value: 'https://cdn.jsdelivr.net/gh/themusecatcher/resources@0.1.2/2.jpg', label: 'photo1' },
        { value: 'https://cdn.jsdelivr.net/gh/themusecatcher/resources@0.1.2/3.jpg', label: 'photo2' }
      ]
    }),
