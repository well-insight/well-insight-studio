...
export default {
  ...
  beforeUnmount() {
    ...
    removeEvent(this.getEventScopeElement(), 'touchstart', this.handleUp)
    removeEvent(this.getEventScopeElement(), 'mousemove', this.move)
    removeEvent(this.getEventScopeElement(), 'touchmove', this.move)
    removeEvent(this.getEventScopeElement(), 'mouseup', this.handleUp)
