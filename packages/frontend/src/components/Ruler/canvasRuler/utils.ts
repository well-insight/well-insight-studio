...
export function drawHorizontalRuler(ctx: any, start: any, shadow: any, options: any) {
...
export function drawVerticalRuler(ctx: any, start: any, shadow: any, options: any) {
  const { scale, width, height, canvasConfigs } = options
  const { bgColor, fontColor, shadowColor, ratio, longfgColor, shortfgColor } = canvasConfigs
