<template>
  <div v-if="currentBlock?._vid && componentItem" class="toolbar-wrapper">
      ...
      <template #dropdown>
        <el-dropdown-menu>
          ...
          <el-dropdown-item>
            <div class="flex w-full items-center justify-between">
              <span>高度</span>
              <el-input-number size="default" :min="0" v-model="currentBlock.height" />
            </div>
          </el-dropdown-item>
          <el-dropdown-item>
            <div class="toolbar-item-row">
              ...
              <div class="toolbar-item-content">
                <el-color-picker
                  ...
                  show-alpha
                  color-format="rgb"
                  v-model="currentBlock.styles.backgroundColor"
                />
              </div>
            </div>
          </el-dropdown-item>
          ...
          <el-dropdown-item>
            <div class="toolbar-item-row">
              ...
              <div class="toolbar-item-content">
                <el-select size="default" v-model="currentBlock.styles.backgroundRepeat" clearable :teleported="false">
          ...
          <el-dropdown-item>
            <div class="toolbar-item-row">
              ...
              <div class="toolbar-item-content">
                <el-select size="default" v-model="currentBlock.styles.backgroundSize" clearable :teleported="false">
    ...
    <el-tooltip content="更多选项" placement="bottom">
      <el-button size="default" text :icon="MoreFilled" class="toolbar-more-btn" @click="openMorePanel" />
    </el-tooltip>
  </div>
 </template>
...
import { Animate, EventAction } from "@/visual-editor/ui/workbench/right-attribute-panel/components";
