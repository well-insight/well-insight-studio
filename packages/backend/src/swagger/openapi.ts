    ...
    components: {
      ...
      schemas: {
        ...
        ResetPasswordRequest: {
          ...
          required: ["password"],
          properties: {
            password: { type: "string", format: "password", minLength: 6, description: "新密码（至少 6 位）" },
          },
        },
      ...
      "/api/v1/auth/login": {
        post: {
          ...
          responses: {
            "200": {
              description: "登录成功",
              content: { "application/json": { schema: { $ref: "#/components/schemas/LoginSuccess" } } },
            },
            "400": {
            ...
            "401": {
              description: "认证失败",
              content: { "application/json": { schema: { $ref: "#/components/schemas/LoginFailure" } } },
            },
            "500": {
              description: "服务器错误",
              content: { "application/json": { schema: { $ref: "#/components/schemas/ErrorBody" } } },
        ...
        get: {
          ...
          responses: {
            ...
            "500": {
              description: "服务器错误",
              content: {
                "application/json": { schema: { $ref: "#/components/schemas/ApiErrorSuccessFalse" } },
              },
            },
          },
        },
              ...
              content: {
                "application/json": {
                  schema: {
                    ...
                    properties: {
                      success: { type: "boolean" },
                      data: { type: "array", items: { $ref: "#/components/schemas/DatasetFolder" } },
                      total: { type: "integer" },
                      message: { type: "string" },
                    },
                  },
