...
import { enUS, zhCN, type WdLocaleMessages } from '@well-design/ui'
...
const messages = {
  'zh-CN': {
    ...
    pillarControlBody: 'WdConfigProvider / createWellDesign 统一浮层挂载、尺寸、密度与文案。',
    docsNav: '文档导航',
    docsTitle: '文档',
    docsMissing: '未找到文档',
    backIntro: '返回介绍',
    ...
    current: '当前',
    currentHint: '当前已发布版本。后续改动请通过 Changesets 记录，发版后会自动出现在此。',
    emptySection: '该版本暂无分类条目。',
    noReleases: '暂无版本记录',
    noReleasesHint: '请先在 packages/ui/CHANGELOG.md 写入发版说明，或运行 pnpm version-packages。',
    guideTitles: {
      introduction: '介绍',
      'quick-start': '快速开始',
      theme: '主题',
  ...
  'en-US': {
    ...
    pillarControlBody: 'WdConfigProvider / createWellDesign unify overlay mount, size, density, and copy.',
    ...
    current: 'Current',
    currentHint: 'This is the current published version. Record later changes with Changesets; they appear here after release.',
    emptySection: 'No entries in this section.',
    noReleases: 'No releases yet',
    noReleasesHint: 'Add notes to packages/ui/CHANGELOG.md, or run pnpm version-packages.',
    guideTitles: {
