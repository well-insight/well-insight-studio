...
title: Configuration
order: 5
description: ConfigProvider, createWellDesign, and useWdConfig.
---

# Configuration

Well Design provides app-level and page-level defaults for overlay mount, size, density, and copy.
...
Priority: **component props > `WdConfigProvider` > `createWellDesign` > built-in default (Chinese)**.
...
```vue preview
<script setup lang="ts">
import { WdConfigProvider, WdInput, WdTextarea } from '@well-design/ui'
</script>
...
<script setup lang="ts">
import { ref } from 'vue'
import { WdConfigProvider, WdSelect, WdButton, WdConfirmDialog } from '@well-design/ui'
...
<script setup lang="ts">
import { ref } from 'vue'
import { WdConfigProvider, WdButton, WdDialog } from '@well-design/ui'
