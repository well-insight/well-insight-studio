 ...
 * Default: commits that touched packages/ui.
 * Answers: Enter (defaults), all, ui, none, or "1,3,5-7"
 */
export async function promptCommitSelection(commits) {
  ...
  console.log('\n  * = touched packages/ui (default selection)')
  console.log('  Enter = keep defaults | all | ui | none | e.g. 1,3,5-7\n')
  ...
  if (answer === 'ui') return commits.filter((commit) => commit.touchesUi)
